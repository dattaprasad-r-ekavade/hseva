...
<head>
  ...
  <title>Scan Attendance Settings | Super Admin | HR Seva</title>
...
<body data-face-page="settings">
  <div class="app">
    ...
    <main class="content">
      <header class="topbar"><div class="topbar-inner d-flex align-items-center gap-2"><button class="btn btn-outline-secondary d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSidebar"><i class="bi bi-list"></i></button><div class="me-auto"><div class="fw-semibold">Scan Attendance Settings</div><div class="small text-muted-3">Set face attendance rules for the selected client.</div></div><button class="btn theme-icon-btn" id="themeToggle" type="button"><i class="bi bi-moon" id="themeIcon"></i></button></div></header>
      <div class="container-fluid py-4 px-3 px-lg-4">
        <div class="glass p-3">
          <form id="settingsForm" class="row g-3">
            ...
            <div class="col-12 col-md-4"><label class="form-label fw-semibold">Timezone</label><input class="form-control" id="timezone" type="text"></div>
            <div class="col-12"><label class="form-label fw-semibold">Model URL</label><input class="form-control" id="modelUrl" type="text"></div>
            <div class="col-12 d-flex gap-2"><button class="btn btn-primary" type="submit"><i class="bi bi-save"></i> Save Settings</button></div>
          </form>
          <div id="pageStatus" class="alert alert-info mt-3 mb-0">Select a client from the top picker before saving settings.</div>
        </div>
      </div>
    </main>
  </div>
