...
<head>
  ...
  <title>Scan Attendance | Super Admin | HR Seva</title>
...
<body data-face-page="scan">
  <div class="app">
    ...
    <main class="content">
      <header class="topbar"><div class="topbar-inner d-flex align-items-center gap-2"><button class="btn btn-outline-secondary d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSidebar"><i class="bi bi-list"></i></button><div class="me-auto"><div class="fw-semibold">Scan Attendance</div><div class="small text-muted-3">IN Scan works by default. Click OUT Scan before scanning if you want to mark employee exit.</div></div><button class="btn theme-icon-btn" id="themeToggle" type="button"><i class="bi bi-moon" id="themeIcon"></i></button></div></header>
          ...
          <div class="col-12 col-xl-5">
            <div class="glass p-3 h-100">
              <div id="scanMessage" class="scan-message p-3">
                ...
                <div class="small text-muted-3" id="scanMessageLine">Use the top client picker first. After that, employees can scan directly without employee selection.</div>
              </div>
            </div>
          </div>
          <div class="col-12">
