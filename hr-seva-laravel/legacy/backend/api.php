...
function kv_get(string $k,$d=null){
  ...
  if (str_ends_with($k, '_index')) {
    ...
    $challanIndexes = ['compliance_challan','pf_return_challan','esic_return_challan'];
    if (in_array($prefix, $challanIndexes, true)) {
      // fall through to app_kv
    } elseif (in_array($prefix, $sheetTypes, true)) {
