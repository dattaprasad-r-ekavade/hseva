...
<head>
  ...
  <title>Monthly Attendance Report | HR Seva</title>
...
<body data-face-page="report">
  <div class="app">
    ...
    <main class="content">
      <header class="topbar"><div class="topbar-inner d-flex align-items-center gap-2"><button class="btn btn-outline-secondary d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSidebar"><i class="bi bi-list"></i></button><div class="me-auto"><div class="fw-semibold">Monthly Attendance Report</div><div class="small text-muted-3">Summarize present, late, early-out, and missing-out counts by employee.</div></div><button class="btn theme-icon-btn" id="themeToggle" type="button"><i class="bi bi-moon" id="themeIcon"></i></button></div></header>
